...
<body>
    <!-- Page Wrapper -->
    <div id="page" class="animsition equal" data-loader-type="loader2" data-page-loader-text="Soulful Travel Services" data-animsition-in="zoom-outy" data-animsition-out="fade-out-up-sm" style="transform-origin: 50% 50vh;">
        <div id="top"></div>
        <!-- Home Section -->
                    ...
                    <div class=" init-animation-2 delay0-4s">
                        <h1 class="cd-headline letters rotate-2 hs-text-2 font-second">
                                <span class="cd-words-wrapper">
                                    <b class="is-visible">we&nbsp;create</b>
                                    <b>unforgettable</b>
                                    <b>immersive&nbsp;cultural</b>
                                    <b>experiences&nbsp;in&nbsp;india</b>
                                </span>
                            </h1>
                    </div>
                    <div class="init-animation-2 delay0-6s">
                        <!--<h2 class="hs-text-6">Sts, a template at the heart of the beauty</h2>-->
                    </div>
                </div>
                            ...
                            <ul class="nav navbar-nav navbar-right cl-effect-5">
                                ...
                                <li>
                                    <a class="ripple-group" href="#process-section">
                                        <span data-hover="why&nbsp;us">why us</span>
                                    </a>
                                </li>
                                <!--<li>
            ...
            <section id="about-section" class="about-section section">
                <div class="container">
                    <div class="section-title">
                        ...
                        <div>
                            <h2 class="section-title-heading">about <span>soulful</span></h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 wow fadeInUp margin-bottom-xs-40">
                            <blockquote class=" about-quote wow fadeInUp" data-wow-delay="0s">
                                <p>"Soulful Travel Services is a Destination Management Company and local experiences provider founded in the year 2016 in Pondicherry, India.</p>

<p>Soulful offers tailor-made tours, local experiences & destination management services in India to overseas tour companies, individual travelers, educational & cultural organizations and other academy’s visiting India.
</p>
<p>
Our team with in-depth knowledge specializes in offering customized travel experiences to explore the unseen sides and our interests in travel range from private travel to small group travel and from short breaks to multi-activity tours and you are encouraged to plan your time and activity as you like. We also offer suggested itineraries to help you to enjoy to the fullest.
"</p>
                                <footer class="">Prasanth
                                </footer>
                            </blockquote>
            ...
            */
                ...
                <div class="container">
                   ...
                   ?>
                    ...
                    <ul id="portfolio-container" class="portfolio-container real-gapped colored-mask masonry clearlist row portfolio-hover-effect">
                        ...
                        <!--/ End Work Item -->
                        <li class="portfolio-item video col-sm-6 col-md-4 col-xs-12">
                            ...
                            <div class="portfolio-item-img">
                                <img src="img/backgrounds/special_interest.jpg" alt="portfolio video work">
                            </div>
                            <div class="portfolio-item-info font-second">
                                <h3 class="portfolio-item-title">Special Interest Tours</h3>
                                <div class="portfolio-item-detail">
                                    <!--<p>Sit amet, consectetur adipi.</p>-->
                                    <!-- LightBox Button -->
                                    <a href="img/backgrounds/special_interest.jpg" data-lightbox-type="iframe" title="Special Interest Tours" class="icon-magnifying-glass lightbox" data-lightbox-gallery="gallery1"></a>
                                    <!--/ End LightBox Button -->
                                    <!--<a href="project_page.html" class="animsition-link icon-attachment"></a>-->
                                </div>
                            </div>
                        ...
                        <!--/ End Work Item -->
                        <li class="portfolio-item web-design video col-sm-6 col-md-4 col-xs-12">
                            <div class="portfolio-item-img">
                                <img src="img/backgrounds/educational_tours.jpg" alt="portfolio" />
                            </div>
                            <div class="portfolio-item-info font-second">
                                <h3 class="portfolio-item-title">Educational Tours</h3>
                                <div class="portfolio-item-detail">
                                    <!--<p>Nobis blanditiis rerum dolor</p>-->
                                    <!-- LightBox Button -->
                                    <a href="img/backgrounds/educational_tours.jpg" title="Educational Tours" class="icon-magnifying-glass lightbox" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/portfolio/work04_lg@2x.jpg"></a>
                                    <!--/ End LightBox Button -->
                                    <!--<a href="project_page.html" class="animsition-link icon-attachment"></a>-->
                                </div>
                            </div>
                        ...
                        <?php
                        /*
                        <li class="portfolio-item photo web-design col-sm-6 col-md-4 col-xs-12">
                            <div class="portfolio-item-img">
                            ...
                            <div class="portfolio-item-info font-second">
                                ...
                                <div class="portfolio-item-detail">
                                    <p>Nobis blanditiis rerum dolor</p>
                                    <!-- LightBox Button -->
                                    <a href="img/portfolio/work05_lg.jpg" title="This is an image title" class="icon-magnifying-glass lightbox" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/portfolio/work05_lg@2x.jpg"></a>
                                    <!--/ End LightBox Button -->
                                    <a href="project_page.html" class="animsition-link icon-attachment"></a>
                                </div>
                            </div>
            ...
            <div class="project-order-section-light in-page-scroll small-section text-center">
                <a href="#contact-section" class="btn btn-animated btn-split btn-dark ripple-alone" data-text="Have a Project in Mind?"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;let's do it then&nbsp;..&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
            </div>
            ...
            <section id="process-section" class="process-section section">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12 wow fadeInUp margin-bottom-xs-40">
                            <blockquote class=" about-quote wow fadeInUp" data-wow-delay="0s">
                                <p>We love to talk and show the different faces of India. In creating our plans, we bring the native India’s perspective while still maintaining an awareness of the travelers’ mindset. </p>
<p>
We believe it
                            ...
                            facilitating a gateway so that our guests can enjoy the best that India has to offer.</p>
                            </blockquote>
                        </div>
                        <!--/.col -->
                    </div>
            ...
            <section id="client-testimonials" class="client-testimonials section  overlay">
                ...
                <div id="testimonials" class="testimonials owl-carousel carousel">
                    <div class="testimo-item">
                        <div class="container">
                            <blockquote>
                                <p>"Soulful Travel gave us an informative and entertaining tour of Pondicherry. The team was friendly and informative. It didn't feel like a tour; it felt more like a well-informed local friend was showing you around. Keep up the good work!"</p>
                                <footer class="">Mr. Preyas Hathi
            ...
            <div class="client-logos small-section">
                <div class="container">
                    <div id="client-logos" class="owl-carousel">
                        <div>
                            <img src="http://placehold.it/200x80" alt="client logo" />
                        </div>
                        <div>
                            <img src="http://placehold.it/200x80" alt="client logo" />
                        </div>
                    ...
                    <div class="row padding-bottom-sm-90">
                        ...
                        <div class="col-sm-4">
                            <div class="contact-item margin-bottom-xs-40"><i class="icon-map-pin"></i>
                                <p>Soulful Travel Services,
                                    <br />97,1st floor, Eswaran koil st,
Pondichéry, Puducherry, India</p>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="contact-item margin-bottom-xs-40"><i class="icon-envelope"></i>
                                <p>soulfultravelservices@gmail.com</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
           ...
           ?>
            ...
            <footer class="footer-section section no-padding-bottom">
                ...
                <div class="footer-social">
                    <a href="https://www.facebook.com/soulfultravelservices/" class="fa fa-facebook-square wow fadeIn" data-wow-offset="150" data-wow-delay="0s"></a>
                    <a href="https://twitter.com/SoulfulTS" class="fa fa-twitter wow fadeIn" data-wow-offset="150" data-wow-delay=".15s"></a>
